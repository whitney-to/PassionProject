...
class LocationResourceIT {
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location().locationName(DEFAULT_LOCATION_NAME).latitude(DEFAULT_LATITUDE).longitude(DEFAULT_LONGITUDE);
        return location;
    }
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location().locationName(UPDATED_LOCATION_NAME).latitude(UPDATED_LATITUDE).longitude(UPDATED_LONGITUDE);
        return location;
    }
    ...
    void putExistingLocation() throws Exception {
        ...
        updatedLocation.locationName(UPDATED_LOCATION_NAME).latitude(UPDATED_LATITUDE).longitude(UPDATED_LONGITUDE);
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.locationName(UPDATED_LOCATION_NAME).longitude(UPDATED_LONGITUDE);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.locationName(UPDATED_LOCATION_NAME).latitude(UPDATED_LATITUDE).longitude(UPDATED_LONGITUDE);
