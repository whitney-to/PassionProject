...
import com.tourista.domain.UserProfile;
import com.tourista.repository.UserProfileRepository;
...
class UserProfileResourceIT {
    ...
    public static UserProfile createEntity(EntityManager em) {
        UserProfile userProfile = new UserProfile().phone(DEFAULT_PHONE);
        return userProfile;
    }
    ...
    public static UserProfile createUpdatedEntity(EntityManager em) {
        UserProfile userProfile = new UserProfile().phone(UPDATED_PHONE);
        return userProfile;
    }
    ...
    void putExistingUserProfile() throws Exception {
        ...
        updatedUserProfile.phone(UPDATED_PHONE);
