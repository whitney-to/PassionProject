...
class ActivityResourceIT {
    ...
    public static Activity createEntity(EntityManager em) {
        Activity activity = new Activity().time(DEFAULT_TIME);
        return activity;
    }
    ...
    public static Activity createUpdatedEntity(EntityManager em) {
        Activity activity = new Activity().time(UPDATED_TIME);
        return activity;
    }
    ...
    void putExistingActivity() throws Exception {
        ...
        updatedActivity.time(UPDATED_TIME);
    ...
    void partialUpdateActivityWithPatch() throws Exception {
        ...
        partialUpdatedActivity.time(UPDATED_TIME);
