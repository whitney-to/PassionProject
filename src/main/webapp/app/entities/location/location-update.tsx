  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="touristaApp.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Location Name" id="location-locationName" name="locationName" data-cy="locationName" type="text" />
