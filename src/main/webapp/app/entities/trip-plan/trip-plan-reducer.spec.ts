...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './trip-plan.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRIPPLAN_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRIPPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRIPPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRIPPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRIPPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRIPPLAN actions', async () => {
      const expectedActions = [
        {
