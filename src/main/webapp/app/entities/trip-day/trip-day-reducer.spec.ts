...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './trip-day.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRIPDAY_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRIPDAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRIPDAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRIPDAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRIPDAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRIPDAY actions', async () => {
      const expectedActions = [
        {
